            ...
            >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">
                      ...
                      <span className="font-semibold text-gray-800">
                        {property.city.city_name || "bengluru"}
                      </span>
                    </p>
                    <p className="text-gray-600 mb-1">
                      Type:{" "}
              ...
              <div className="flex justify-between flex-wrap gap-2 items-center p-3 bg-white rounded-b-xl border-t border-gray-200">
                <div className="flex flex-wrap gap-2 border-gray-300 ">
                  ...
                  <div className="bg-indigo-100 text-indigo-800 py-2 px-2 lg:py-1.5 lg:px-3 rounded-lg border border-indigo-300">
                    {property.area} sq ft
                  </div>
