...
const FindYourHome = ({ filterfunc }) => {
  ...
  const handleLocalityChange = (selectedOptions) => {
    ...
    dispatch({ type: "location", value: values });
  };
  ...
  return (
    <div className="w-full p-4 bg-gray-100 shadow-md mt-9 ">
      ...
      <div className=" w-full mb-2">
        {/* <div className="relative w-full lg:py-2 text-yellow-700 focus:outline-none ">
          <input
            type="text"
          ...
          {cities.length > 0 && (
            <div className="max-h-[30vh] absolute top-10 left-0 w-full flex flex-col bg-gray-700 border-2 z-50 overflow-y-auto">
              {cities.map((city, i) => (
                <span
                  onClick={() => {
